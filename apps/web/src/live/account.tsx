...
export function LiveAccountScreen(){
  ...
  const resource=useApiResource(async()=>{
    ...
    try{staffRoles=(await api.adminMe()).roles;}catch{/* regular accounts are not staff */}
    ...
    return {profile:profile.profile,wallet,equipment:equipment.equipment,androidUpdate,staffRoles};
  },[]);
